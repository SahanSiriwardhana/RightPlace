                ...
                <div class="inner-container clearfix">
                    ...
                    <div class="top-right">
                        ...
                        <ul class="social-icon-one clearfix">
                           ...
                           <li><button class="btn-box theme-btn btn-style-four btn-1">Post Your Add</button></li>
                    ...
                    <nav class="main-menu">
                        <div class="navbar-collapse show collapse clearfix">
                            <ul class="navigation clearfix">
                                        ...
                                        <li><a href="/contact">Contact Us</a></li>
                                <li>
                                    <div class="btn-box" style="padding-top: 5px"><a href="admin/submit-property.html" class="theme-btn btn-style-four">Post Your Add</a></div>
                                </li>
                            </ul>              
                        </div>
                    </nav><!-- Main Menu End-->
                        ...
                        <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" style="padding-bottom:5% ; " aria-labelledby="nav-home-tab">
                                        ...
                                        <form action="{{route('signin')}}" method="POST" >
                                            ...
                                            <div align="left"><small ><u>Forgot Password?</u></small></div>
                                ...
                                <div class="footer-widget cities-widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="list clearfix">
                                            ...
                                            <li><a href="properties.html">Chicago</a></li>
                                            <li><a href="properties.html">Coleman</a></li>
                                            <li><a href="properties.html">Corpus Christi</a></li>
                                            <li><a href="properties.html">Dallas</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>         
...
<script>
        if ($("#Regform").length > 0) {
         ...
         messages: {
           ...
           password:{
            minlength:"Your password minlength should be 5 characters long."
           },
