                           ...
                           {{$land->description}}
                            <blockquote>
                                    <h5>   
                                        ...
                                        @endif
                                        <i class="la la-map-signs la-2x"></i>Land Size : <span style="color:grey">{{$land->land_size }} {{$land->land_size_type}}</span><br>
                                        <i class="la la-archive la-2x"></i> Item Condition :<span style="color:grey"> {{$land->item_condition }} </span><br>
                        ...
                        <div class="lower-content">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                        <button class="theme-btn btn-style-one approveAddHouse" data-id="{{$land->id}}" data-token="{{@csrf_token()}}">Approve</button>
                                </div>
                                @endif
