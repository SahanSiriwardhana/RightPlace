                    ...
                    <div class="row">
                            <div class="about-property col-lg-8 col-md-12 col-sm-12">
                                ...
                                <div class="location"><i class="la la-map-marker"></i>
                                    ...
                                    @endforeach | <i class="la  la-clock-o"></i>{{$land->updated_at}} | <i class="la la-tag"></i> PORTION & ROOMS
                                </div>
                            ...
                            <p>{{$land->description}}</p>
                                <blockquote>
                                    <h5>   
                                        ...
                                        @endif
                                        <i class="la la-map-signs la-2x"></i> Gender : <span style="color:grey">
                                            @if ($land->gender=='1')
                                                Male
                                            @elseif ($land->gender=='2')
                                                Female
                                            @else 
                                                Unisex  
                                            @endif
                        ...
                        <div class="lower-content">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                        <button class="theme-btn btn-style-one approveAddRoom" data-id="{{$land->id}}" data-token="{{@csrf_token()}}">Approve</button>
                                </div>
                                @endif
