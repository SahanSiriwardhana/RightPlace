	            ...
	            <div class="dashboard-content">
	                <div class="dashboard-header clearfix">
	                    <div class="row">
							...
							<h5>@if ($commercial->type==1)
									Sale
								@else
								Rent
								@endif -> Commercial Property</h5>
							</div>
	                    	...
	                    	<div class="properties-box">
	                    		<div class="inner-container">
	                    			<div class="property-submit-form">
										<form method="post" action="/update-commercial-property/{{$commercial->id}}" enctype="multipart/form-data" id="formData" >
											{{ csrf_field() }}
												...
												<div class="row">
														...
														<select class="" name="city" id="js-example-basic-single" required>
															...
															@foreach ($districts as $district)
																<option value="{{$district->did}}"
																		@if ($district->did==$commercial->city)
																		selected
																		@endif
													...
													<div class="form-group col-lg-12 col-md-6 col-sm-12">
														<div class="range-slider-one clearfix">
															<label>Address</label>
															<input type="text" name="address" placeholder="Address" value="{{$commercial->address}}">
														</div>
													</div>
												</div>
												</div>
											...
											<div class="col-lg-12 popoverDat"  class="btn" href="#" data-content="Popover with data-trigger" rel="popover" data-placement="right" data-original-title="Title" data-trigger="hover">
												<div class="row" id="drop" data-id="/update-image-commercial-property" data-token="{{$commercial->id}}">
													<!-- Form Group -->
			                                ...
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-12 col-md-6 col-sm-12">
													...
													<input type="text" name="addTitle" placeholder="Property Title" required value="{{$commercial->title}}" onkeyup="countChar2(this)">
			                                    ...
			                                    <div class="form-group col-lg-6 col-md-6 col-sm-12">
			                                        ...
			                                        <select class="custom-select-box"  name="itemType">
		                                                ...
		                                                <option value="Building" @if($commercial->item_type=='Building') selected @endif>Building</option>
		                                                <option value="Factory/Workshop" @if($commercial->item_type=='Factory/Workshop') selected @endif>Factory/Workshop</option>
		                                                <option value="Hotel" @if($commercial->item_type=='Hotel') selected @endif>Hotel</option>
                                                        <option value="Resturant" @if($commercial->item_type=='Resturant') selected @endif>Resturant</option>
                                                        <option value="Shops" @if($commercial->item_type=='Shops') selected @endif>Shops</option>
		                                                <option value="Warehouses/Storage" @if($commercial->item_type=='Warehouses/Storage') selected @endif>Warehouses/Storage</option>
		                                                <option value="Other" @if($commercial->item_type=='Other') selected @endif>Other</option>
		                                            </select>
			                                    </div>
                                                  ...
                                                  <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                                        <label>Size*</label>
															<input type="text" name="size" placeholder="Size (sqft)" required value="{{$commercial->size}}">
														
                                                        
                                                        </div>
												<div class="form-group col-lg-6 col-md-6 col-sm-12">
			                                        <label>Price *</label>
													<input type="text" name="rentPerMonth" placeholder="Pick a good price (LKR)" required value="{{$commercial->rent_per_month}}">
			                                    </div>
													...
													<div class="form-group col-lg-3 col-md-6 col-sm-12 ">
														...
														<div class="form-group col-lg-3 col-md-6 col-sm-12 ">
															<div class="check-box">
																...
																@if ($commercial->water_supply_from_main_supply=='1')
																checked
																@endif> 
														...
														<div class="form-group col-lg-3 col-md-6 col-sm-12 ">
															<div class="check-box">
																...
																@if ($commercial->water_supply_from_well=='1')
																checked
																@endif> 
														...
														<div class="form-group col-lg-3 col-md-6 col-sm-12 ">
															<div class="check-box">
																...
																@if ($commercial->seveage_system=='1')
																checked
																@endif> 
			                                ...
			                                <div class="row">
			                                	<!-- Form Group -->
			                                    <div class="form-group col-lg-12">
													<textarea name="detailInfo" placeholder="Detailed Information*" required  onkeyup="countChar(this)">{{$commercial->description}}</textarea>
			                                ...
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-6 col-md-6 col-sm-12">
			                                        <label>Phone</label>
													<input type="text" name="phone" placeholder="Phone" required value="{{$commercial->phone}}">
